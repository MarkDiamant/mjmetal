...
projects.
      ...
      <footer className="border-t border-neutral-200 bg-white px-6 py-10 text-neutral-800">
        ...
        <div className="mx-auto mt-10 max-w-7xl border-t border-neutral-200 pt-6 text-sm text-neutral-500 sm:flex sm:items-center sm:justify-between sm:gap-6">
          ...
          <a href="https://diamantsolutions.co.uk" target="_blank" rel="noopener noreferrer" className="builtBy"><span className="builtByLine"><span>Built by</span><img src="https://www.samcerts.co.uk/diamant-solutions-logo.svg" alt="Diamant Solutions"/></span><span className="builtByTag">Websites • Business Software • Direction</span><strong className="builtByCta">Want something built?</strong></a>
        </div>
      </footer>
    </main>
  );
