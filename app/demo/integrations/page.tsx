...
export default function IntegrationsPage() {
  ...
  async function load() {
    setLoading(true);
    const response = await fetch("/api/demo/integrations/xero/status", { cache: "no-store" });
