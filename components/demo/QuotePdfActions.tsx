...
export default function QuotePdfActions({ reference, quoteId }: { reference: string; quoteId: string }) {
  ...
  async function generate(){
    ...
    try{
      ...
      const response=await fetch(`/api/demo/jobs/${encodeURIComponent(reference)}/quotes/${encodeURIComponent(quoteId)}/pdf`,{method:"POST",headers:{"Content-Type":"application/pdf"},body:blob});
