    ...
    <main className="min-h-screen bg-[#f5f5f2] px-5 py-10 text-[#141414]">
      <div className="mx-auto max-w-3xl rounded-3xl border border-black/10 bg-white p-7 shadow-[0_12px_40px_rgba(0,0,0,0.06)] sm:p-10">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-black/65">
          The admin system is built separately from the public website and is waiting for the dedicated M&J Supabase project before live customer data is enabled.
        </p>

        <div className="mt-7 grid gap-3 sm:grid-cols-2">
          {[
            "Separate Mark and Jonathan logins",
        ...
        <div className="mt-7 rounded-2xl border border-[#e66a24]/25 bg-[#fff7f1] p-5">
          ...
          <p className="mt-2 text-sm leading-6 text-black/65">Create the new M&J Supabase project and add its URL and publishable key to Vercel. The CRM can then be switched from setup mode to live mode.</p>
        </div>
      </div>
    </main>
  );
